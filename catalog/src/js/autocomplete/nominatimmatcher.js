...
goog.provide('goog.ui.ac.NominatimMatcher');
 ...
 * @constructor
 */
goog.ui.ac.NominatimMatcher = function(opt_url, opt_payload) {
 ...
 *     matching.
 */
goog.ui.ac.NominatimMatcher.prototype.requestMatchingRows =
  ...
  this.request_ = this.jsonp_.send(this.payload_, function(e) {
    ...
    for (var i = 0; i < e.length; i++) {
      if (goog.array.indexOf(uniqueArray, e[i]['display_name']) < 0) {
